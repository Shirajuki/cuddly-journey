...
for i in range(1,25):
    ...
    print(payload)
    os.system(payload)
    payload = f"python3 ./scripts/tts_srt_parsing/tts-edge.py ep{i}.srt && powershell.exe -c '[console]::beep(500,300)'; python3 ./scripts/process_video/standalone.py && cp ./scripts/output/output.mp3 ep{i}.mp3 && powershell.exe -c '[console]::beep(500,300)'"
    print(payload)
    os.system(payload)
