...
export const TTS_VOLCENGINE_VOICES = [
  { name: "zh_male_rap", gender: "male", language: "Chinese" },
  { name: "zh_female_sichuan", gender: "female", language: "Chinese" },
  { name: "tts.other.BV021_streaming", gender: "male", language: "Chinese" },
  { name: "tts.other.BV026_streaming", gender: "male", language: "Chinese" },
  { name: "tts.other.BV025_streaming", gender: "female", language: "Chinese" },
  { name: "zh_male_xiaoming", gender: "male", language: "Chinese" },
  { name: "zh_male_zhubo", gender: "male", language: "Chinese" },
  { name: "zh_female_zhubo", gender: "female", language: "Chinese" },
  { name: "zh_female_qingxin", gender: "female", language: "Chinese" },
  { name: "zh_female_story", gender: "female", language: "Chinese" },
  { name: "en_male_adam", gender: "male", language: "English" },
  { name: "tts.other.BV027_streaming", gender: "female", language: "English" },
  { name: "en_male_bob", gender: "male", language: "English" },
  { name: "tts.other.BV032_TOBI_streaming", gender: "female", language: "English" },
  { name: "tts.other.BV516_streaming", gender: "male", language: "English" },
  { name: "en_female_sarah", gender: "female", language: "English" },
  { name: "jp_male_satoshi", gender: "male", language: "Japanese" },
  { name: "jp_female_mai", gender: "female", language: "Japanese" },
  { name: "kr_male_gye", gender: "male", language: "Korean" },
  { name: "tts.other.BV059_streaming", gender: "female", language: "Korean" },
  { name: "fr_male_enzo", gender: "male", language: "French" },
  { name: "tts.other.BV078_streaming", gender: "female", language: "French" },
  { name: "de_female_sophie", gender: "female", language: "German" },
  { name: "es_male_george", gender: "female", language: "Spanish" },
  { name: "tts.other.BV065_streaming", gender: "female", language: "Spanish" },
  { name: "tts.other.BV068_streaming", gender: "female", language: "Russian" },
  { name: "tts.other.BV087_streaming", gender: "male", language: "Italian" },
  { name: "tts.other.BV083_streaming", gender: "male", language: "Turkish" },
  { name: "tts.other.BV531_streaming", gender: "male", language: "Portugese" },
  { name: "pt_female_alice", gender: "female", language: "Portugese" },
  { name: "tts.other.BV075_streaming", gender: "male", language: "Vietnamese" },
  { name: "tts.other.BV074_streaming", gender: "female", language: "Vietnamese" },
  { name: "tts.other.BV092_streaming", gender: "female", language: "Malay" },
  { name: "tts.other.BV570_streaming", gender: "male", language: "Arabic" },
  { name: "tts.other.BV160_streaming", gender: "male", language: "Indonesian" },
  { name: "id_female_noor", gender: "female", language: "Indonesian" },
] as TTSType[];

export const TTS_YOUDAO_VOICES = [
  { name: "zh", language: "Chinese" },
  { name: "en", language: "English" },
  { name: "jp", language: "Japanese" },
  { name: "ko", language: "Korean" },
  { name: "fr", language: "French" },
  { name: "es", language: "Spanish" },
  { name: "ru", language: "Russian" },
  { name: "de", language: "German" },
  { name: "it", language: "Italian" },
  { name: "tr", language: "Turkish" },
  { name: "pt", language: "Portugese" },
  { name: "vi", language: "Vietnamese" },
] as TTSType[];
